...
function DashboardTab() {
    ...
    const { mode, product, edithandle, deleteProduct, updateProduct,order, user } = context
                    ...
                    <Tabs defaultIndex={0} className=" " >
                        ...
                        <TabPanel>
                            <div className='  px-4 md:px-0 mb-16'>
                                <h1 className=' text-center mb-5 text-3xl font-semibold underline' style={{ color: mode === 'dark' ? 'white' : '' }}>Event Schedule</h1>
                                <div className=" flex justify-end">
                                    <button
                                    onClick={add}
                                        type="button"
                                        className="focus:outline-none text-white bg-cyan-700 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
                                            Add Event <MdOutlineEventNote size={20} />
                                        </div></button>
                                </div>
                                    ...
                                    return(
                                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                            ...
                                            {allorder.cartItems.map((item,index)=>{
                                                const{title,description,category,imageUrl1,price}=item;
                                                return(
                                                    <tbody>
                                                        ...
                                                        <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                            ...
                                                            {/* //For showing Grand Total purpose...need UI modification */}
                                                        </tr>
                        ...
                        <TabPanel>
                            ...
                            <div className="relative overflow-x-auto mb-10">
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    {user.map((item,index)=>{
                                        const{name,uid, email, date,phoneNumber} = item;
                                        return(
                                            <tbody>
