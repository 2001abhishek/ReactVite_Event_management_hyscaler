...
function Filter() {
    ...
    const { mode, searchkey, setSearchkey, filterType, setFilterType,
        filterPrice, setFilterPrice, product, resetSearchKey,
        resetFilterType,
        resetFilterPrice } = context

    const handleResetFilter = () => {
        resetSearchKey(); // Function to reset search key
        resetFilterType(); // Function to reset filter type
        resetFilterPrice(); // Function to reset filter price
    };
    const priceRanges = [
    ...
    return (
        <div className=' container mx-auto px-1 mt-1 '>
            <div className="p-2 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200
"  style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <button
                        onClick={handleResetFilter} // Call handleResetFilter on click
