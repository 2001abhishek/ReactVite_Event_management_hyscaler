...
function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : 'rgb(243 243 243)',
        color: mode === 'dark' ? 'white' : 'black',
      }}
    >
      <div className="container px-5 py-2 mx-auto pt-20">
      ...
      <div
        ...
        style={{
          backgroundColor: mode === 'dark' ? 'rgb(55 57 61)' : 'rgb(230 230 230)',
          color: mode === 'dark' ? 'white' : 'black',
        }}
      >
        <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4">
            ...
            <a className="ml-3 text-gray-500" href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
            ...
            <a className="ml-3 text-gray-500" href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
              <svg
                fill="currentColor"
                stroke="currentColor"
                strokeLinecap="round"
